...
struct JoinScanImpl : public OperatorNew<JoinScanImpl<ColumnType>, join_types> {
  ...
  void execute_special(OuterTableType* outer, OuterStoreType* outer_store, OuterDictType<ColumnType>* outer_dict,
                       InnerTableType* inner, InnerStoreType* inner_store, InnerDictType<ColumnType>* inner_dict,
  ...
  void execute_fallback(ATable* a, AStorage* a1, ADictionary* a2,
